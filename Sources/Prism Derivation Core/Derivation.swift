...
public enum Derivation {
    public static func expansion(
        ...
        expansion(Analysis(declaration))
    }
    ...
    private static func rawType(of analysis: Analysis) -> String? {
        guard
    ...
    private static func constructorArgument(
        _ value: String,
        at offset: Int,
        in coproductCase: Analysis.Case
    ) -> String {
